...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/assets/pdf/resume_260722.pdf";
          },
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-received-iccad-2025-student-scholar-program-award-sparkles-smile",
          title: 'Received ICCAD 2025 Student Scholar Program Award! :sparkles: :smile:',
          description: "",
          section: "News",},{id: "news-my-ibm-internship-paper-codmas-a-dialectic-multi-agent-collaborative-framework-for-structured-rtl-optimization-has-been-accepted-to-eacl-2026-industrial-track-tada-tada",
          title: 'My IBM internship paper, ‘‘CODMAS: A Dialectic Multi-Agent Collaborative Framework for Structured RTL...',
          description: "",
          section: "News",},{id: "news-my-paper-encoding-symmetries-into-operator-learning-towards-accurate-multi-physics-simulation-in-advanced-packaging-has-been-accepted-to-asp-dac-2027-tada-tada",
          title: 'My paper, ‘‘Encoding Symmetries into Operator Learning: Towards Accurate Multi-Physics Simulation in Advanced...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=IkYIgSQAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
